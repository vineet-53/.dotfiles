...
opt.undodir = "/home/vscoder/.undodir"  -- Set the directory for storing undo history
...
-- Format options
vim.opt.formatoptions:remove({ "c", "r", "o" })  -- Remove the default behavior of formatting comments on new lines
